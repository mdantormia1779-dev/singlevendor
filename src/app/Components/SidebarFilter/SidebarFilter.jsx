            ...
            <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm space-y-6">
                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        />
                        <button className="absolute right-1.5 top-1.5 p-1 bg-[#10b981] text-white rounded-md hover:bg-[#0f9f6e] transition-colors">
                ...
                <div>
                    ...
                    <div className="space-y-2">
                        <div className="flex justify-between text-xs text-slate-400">
                            ...
                            <button className="text-slate-400 hover:text-slate-600">reset</button>
                        </div>
                        <div className="h-1.5 bg-slate-100 rounded-full relative my-4">
                            <div className="absolute h-full w-[80%] bg-[#10b981] rounded-full"></div>
                            <div className="absolute w-3.5 h-3.5 bg-white border-2 border-[#10b981] rounded-full -top-1 right-[20%] shadow-sm cursor-pointer"></div>
                        </div>
                ...
                <div className="space-y-2 pt-2">
                    <button className="w-full bg-[#10b981] hover:bg-[#0f9f6e] text-white py-2.5 rounded-xl font-medium text-sm transition-all shadow-sm shadow-emerald-100">
                        Apply Filter
                    </button>
                    <button className="w-full bg-white hover:bg-slate-50 text-slate-500 border border-slate-200 py-2.5 rounded-xl font-medium text-sm transition-all">
                        Clear All Filters
                    </button>
                </div>
