...
const HOME_KEYWORDS = ["Home", "Living", "Decor", "Lamp", "Chair", "Table", "Bed", "Kitchen", "Towel", "Room"];
...
export default function HomeLivingPage() {
  ...
  const baseList = categoryProducts.length > 0 ? categoryProducts : productsData.slice(2, 9);
  ...
  const categories = useMemo(() => {
    const counts = {};
    baseList.forEach((p) => {
      const cat = p.specifications?.category || "Home & Living";
