...
import { UploadCloud, X, Calendar, ChevronDown, Check, Loader2, ArrowLeft } from "lucide-react";
    ...
    <div className="p-4 sm:p-8 bg-gray-50 min-h-screen">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-1">Create and list a new item in your store catalogue</p>
        </div>
        <div className="flex items-center gap-2 text-xs sm:text-sm text-gray-500">
          ...
          <span>{">"}</span>
          <span className="text-orange-600 font-medium">Add Product</span>
        </div>
      </div>

      {/* Form Container */}
      <form onSubmit={handleSave} className="bg-white p-6 sm:p-8 rounded-3xl shadow-sm border border-gray-100 space-y-8">
        ...
        <div>
          ...
          <p className="text-xs text-gray-400 mt-2">
            Recommended image size: 800x800px. High quality transparent or neutral background photos work best.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              type="text"
              placeholder="e.g. Nike, Zara, Finora Original"
              value={brand}
        ...
        <div>
          ...
          <textarea
            rows={5}
            placeholder="Write key details, material composition, sizing information, origin, and product features..."
            value={description}
        ...
        <div className="flex items-center gap-4 pt-4 border-t border-gray-100">
          ...
          >
            ...
            <span>{isLoading ? "Publishing..." : "Save & Publish"}</span>
          </button>
